 ...
 * </p>
 */
public class TestRecord extends ConnectRecord<TestRecord> {


    public TestRecord(String topic, Integer partition,
                      Schema keySchema, Object key,
                      Schema valueSchema, Object value,
                      Long timestamp) {
        super(topic, partition, keySchema, key, valueSchema, value, timestamp, null);
    }

    public TestRecord(String topic, Integer kafkaPartition,
                         Schema keySchema, Object key,
                         Schema valueSchema, Object value,
                         Long timestamp, Iterable<Header> headers) {
        super(topic, kafkaPartition, keySchema, key, valueSchema, value, timestamp, headers);
    }


    @Override
    public TestRecord newRecord(String topic, Integer kafkaPartition, Schema keySchema, Object key, Schema valueSchema, Object value, Long timestamp) {
        return newRecord(topic, kafkaPartition, keySchema, key, valueSchema, value, timestamp, headers().duplicate());
    }

    @Override
    public TestRecord newRecord(String topic, Integer kafkaPartition, Schema keySchema, Object key, Schema valueSchema, Object value, Long timestamp, Iterable<Header> headers) {
        return new TestRecord(topic, kafkaPartition, keySchema, key, valueSchema, value, timestamp, headers);
    }
